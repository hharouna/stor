...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
  ...
  <main class="px-3">
    <h1>Mise à jour</h1>
    <p class="lead">En raison de la crise covid-19
    nous avons suppendus toutes activitées ... 
    
    <h2>Contats info@vetechdesign.net</h2> 
  ...
  <footer class="mt-auto text-white-50">
    <p>Cover template for <a href="https://vetechdesign.net" class="text-white">Vetechdesign</a>, by </p>
  </footer>
</div>
