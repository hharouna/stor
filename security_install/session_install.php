...
public function session($_url_session_name,$_true_false,$_domaine,$lien_dossier){
		...
		$valeur = session_id();
		$dossier   = "/".$lien_dossier;// dossier de stockage de la session
		$domain   = $_domaine ;
    ...
    */
    ...
    public function f_deconnect($_url_session_name,$true_false,$_domaine ,$lien_dossier){
        /*
    ...
    public function f_deconnet_($name){
        /*
           deconnexion page
        */
